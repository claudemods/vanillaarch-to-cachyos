...
echo -e "${CYAN}"
echo "           claudemods Vanilla Arch Gnome Systemd-Boot to CachyOS Gnome Systemd-Boot v1.01 28-10-2025"
echo -e "${NC}"
echo "================================================================================"
echo ""
...
cp -r /home/$USER/vanillaarch-to-cachyos/install-fullgnome-systemd-boot/config.fish /home/$USER/.config/fish/config.fish
cp -r /home/$USER/vanillaarch-to-cachyos/install-fullgnome-systemd-boot/.zshrc /home/$USER/.zshrc
