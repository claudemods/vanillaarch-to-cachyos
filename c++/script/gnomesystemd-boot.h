#ifndef GNOMESYSTEMDBOOT_H
#define GNOMESYSTEMDBOOT_H
...
class GnomeSystemdBootMigration {
private:
    ...
    void displayBanner() {
        ...
        std::cout << " ░╚════╝░╚══════╝╚═╝░░░░░░╚═════╝░╚══════╝░╚══════╝╚═╝░░░░░╚═╝░╚════╝░╚═════╝░╚═════╝░" << std::endl;
        std::cout << CYAN;
        std::cout << "           claudemods Vanilla Arch Gnome Systemd-Boot to CachyOS Gnome Systemd-Boot v1.0 24-10-2025" << std::endl;
        std::cout << NC;
        std::cout << "================================================================================" << std::endl;
        std::cout << std::endl;
    }
